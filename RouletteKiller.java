...
public class RouletteKiller {
    ...
    private int spinwhendouble = 0;
    private int spinwhenmax =  0;
    private int betwhendouble = 0;
    private int betwhenmax =  0;



    String RouletteKiller1(int starter){
      ...
      //  System.out.println("-----------------------");
       ...
       // System.out.println("The result : " + result);
        ...
        return spin + ";" + spinswithoutbet + ";" + (spin - spinswithoutbet)
                + ";" + doubledthemony + ";" + spinwhendouble + ";" + betwhendouble + ";" + maxbudget + ";"
                + spinwhenmax + ";" + betwhenmax;
     }
